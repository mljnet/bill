# Script Mikrotik untuk Mengatur DNS Server GenieACS
...
/ppp profile add name="genieacs-dns" local-address=192.168.10.1 \
    ...
    comment="Profile dengan DNS server GenieACS"
...
/ip firewall address-list add address=192.168.10.0/24 list="tr069-users" \
    comment="PPPoE Users untuk TR069"

# ===========================================
# 8. VERIFIKASI KONFIGURASI
# ===========================================

:put "=== KONFIGURASI DNS GENIEACS SELESAI ==="
...
echo "Script DNS GenieACS telah dibuat!"
